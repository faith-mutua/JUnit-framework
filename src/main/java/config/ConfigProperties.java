...
public class ConfigProperties {
    ...
    public static String testimUrl = appConfig.getTestimUrl();

    public static String imageDownloadUrl = appConfig.getimageDownloadUrl();
    ...
    public static String orgPageUrl = appConfig.getOrgPageUrl();
